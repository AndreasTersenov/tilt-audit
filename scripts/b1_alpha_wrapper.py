#!/usr/bin/env python
"""Run particle-reasoners' run_reliability.py with DEFENSIVE_IID_FRACTION overridden.
...
with the remaining CLI args — particle-reasoners itself stays read-only.
...
REPO = "/home/tersenov/software/particle-reasoners"
